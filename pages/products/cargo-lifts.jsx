...
const CargoLiftsPage = ({data, page, category, maxPage}) => {
    ...
    return (
        <main>
            <Head>
              <title>Jual Cargo Lift di BJA Hoist | Melayani jasa service hoist crane dan system electrical hoist crane serta pemasangan instalasi electrical hoist crane</title>
              <meta name="description" content="BJA Hoist menjual cargo lift dengan kualitas terbaik. BJA Hoist / bjahoist (Bintang Jaya Abadi) melayani jasa service hoist crane dan system electrical hoist crane, pemasangan instalasi electrical hoist crane, pembuatan cargo lift / lift barang, serta penjualan hoist crane,chain hoist, wire rope hoist, dan bagian atau aksesoris hoist" />
            ...
            <CargoLift data={data}  category={category} />
...
export async function getServerSideProps({query}) {
    try {
        let response = await axios.get(`/products/cargo-lifts?page=${query.page ? query.page : 1}`)
